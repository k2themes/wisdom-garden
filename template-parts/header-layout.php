...
$header_layout = k2_theme_frame_get_opt( 'header_layout' );
$singe_service_layout = k2_theme_frame_get_opt( 'singe_service_layout', 'default' );
$h_class = '';
if($header_layout == 1 && $singe_service_layout == 'default' && is_singular('service') || $header_layout == 1 && $singe_service_layout == 'default' && is_singular('portfolio')) {
    $h_class = 'fixed-height';
}
?>
<header id="masthead" class="site-header">
    <div id="site-header-wrap" class="header-layout1 header-transparent <?php echo esc_attr($h_class); ?> <?php if($sticky_on == 1) { echo 'is-sticky'; } ?>">
        <div id="headroom">
