...
$post_social_share_on = k2_theme_frame_get_opt( 'post_social_share_on', false );
...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-hentry'); ?>>
    ...
    <div class="entry-holder">
        ...
        <div class="entry-content-bottom clearfix">
            <?php if(isset($post_social_share_on) && $post_social_share_on) : ?>
                <div class="entry-social-share style-default cms-box clearfix">
                    <label><?php echo esc_html__('Share', 'k2_text_domain'); ?></label>
                    <?php k2_theme_frame_socials_share_default(); ?>
                </div>
            <?php endif; ?>
            <?php if($post_tags_on) : ?>
