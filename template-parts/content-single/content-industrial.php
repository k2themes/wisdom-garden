...
$post_social_share_on_industrial = k2_theme_frame_get_opt( 'post_social_share_on_industrial', false );
$post_author_info_on = k2_theme_frame_get_opt( 'post_author_info_on', false );
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('single-hentry content-industrial'); ?>>
    ...
    <div class="entry-holder">
        ...
        <div class="entry-content-bottom clearfix">
            <?php if(isset($post_social_share_on_industrial) && $post_social_share_on_industrial) : ?>
