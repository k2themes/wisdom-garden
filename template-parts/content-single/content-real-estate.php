...
$post_social_share_on_real = k2_theme_frame_get_opt( 'post_social_share_on_real', false );
$post_author_info_on = k2_theme_frame_get_opt( 'post_author_info_real_on', false );
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('single-hentry single-post-real-estate'); ?>>
    ...
    <?php if($post_tags_on || $post_social_share_on_real) : ?>
        <div class="entry-content-bottom">
            <?php if($post_tags_on) : ?>
                <?php k2_theme_frame_entry_tagged_in(); ?>
            <?php endif; ?>
            <?php if(isset($post_social_share_on_real) && $post_social_share_on_real) : ?>
                <div class="social-share">
                    <?php k2_theme_frame_socials_share_real(); ?>
                </div>
            <?php endif; ?>
        </div>
    <?php endif; ?>
...
<?php k2_theme_frame_related_post_real(); ?>